...
namespace Models
{
	...
	public partial class Model14_EP : IGeneratedAlgorithm
	{
		...
		private void Constant()
		{
			...
			// Message to 'vbool30' from IsGreaterThan factor
			vbool30_F = IsGreaterThanOp.IsGreaterThanAverageConditional(1, successCount_F);
			...
			// Message to 'vbool31' from Not factor
			vbool31_F = BooleanNotOp.NotAverageConditional(vbool30_F);
