...
namespace Models
{
	...
	public partial class Model15_EP : IGeneratedAlgorithm
	{
		...
		private void Constant()
		{
			...
			// Message to 'vbool32' from IsGreaterThan factor
			vbool32_F = IsGreaterThanOp.IsGreaterThanAverageConditional(3, successCount_F);
			...
			// Message to 'vbool33' from Not factor
			vbool33_F = BooleanNotOp.NotAverageConditional(vbool32_F);
