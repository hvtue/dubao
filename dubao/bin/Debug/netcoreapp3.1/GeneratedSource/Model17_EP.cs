...
namespace Models
{
	...
	public partial class Model17_EP : IGeneratedAlgorithm
	{
		...
		private void Constant()
		{
			...
			// Message to 'vbool36' from IsGreaterThan factor
			vbool36_F = IsGreaterThanOp.IsGreaterThanAverageConditional(2, successCount_F);
			...
			// Message to 'vbool37' from Not factor
			vbool37_F = BooleanNotOp.NotAverageConditional(vbool36_F);
