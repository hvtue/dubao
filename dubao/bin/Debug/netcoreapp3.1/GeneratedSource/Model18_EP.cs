...
namespace Models
{
	...
	public partial class Model18_EP : IGeneratedAlgorithm
	{
		...
		private void Constant()
		{
			...
			// Message to 'vbool38' from IsGreaterThan factor
			vbool38_F = IsGreaterThanOp.IsGreaterThanAverageConditional(1, successCount_F);
			...
			// Message to 'vbool39' from Not factor
			vbool39_F = BooleanNotOp.NotAverageConditional(vbool38_F);
