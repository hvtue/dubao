...
namespace Models
{
	...
	public partial class Model19_EP : IGeneratedAlgorithm
	{
		...
		private void Constant()
		{
			...
			// Message to 'vbool40' from IsGreaterThan factor
			vbool40_F = IsGreaterThanOp.IsGreaterThanAverageConditional(5, successCount_F);
			...
			// Message to 'vbool41' from Not factor
			vbool41_F = BooleanNotOp.NotAverageConditional(vbool40_F);
