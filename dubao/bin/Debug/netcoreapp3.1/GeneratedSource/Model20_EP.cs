...
namespace Models
{
	...
	public partial class Model20_EP : IGeneratedAlgorithm
	{
		...
		private void Constant()
		{
			...
			// Message to 'vbool42' from IsGreaterThan factor
			vbool42_F = IsGreaterThanOp.IsGreaterThanAverageConditional(2, successCount_F);
			...
			vbool43_F = BooleanNotOp.NotAverageConditional(vbool42_F);
