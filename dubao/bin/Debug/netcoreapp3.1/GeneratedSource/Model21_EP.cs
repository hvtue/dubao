...
namespace Models
{
	...
	public partial class Model21_EP : IGeneratedAlgorithm
	{
		...
		private void Constant()
		{
			...
			// Message to 'vbool44' from IsGreaterThan factor
			vbool44_F = IsGreaterThanOp.IsGreaterThanAverageConditional(2, successCount_F);
			...
			// Message to 'vbool45' from Not factor
			vbool45_F = BooleanNotOp.NotAverageConditional(vbool44_F);
