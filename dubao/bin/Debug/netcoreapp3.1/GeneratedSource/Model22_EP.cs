...
namespace Models
{
	...
	public partial class Model22_EP : IGeneratedAlgorithm
	{
		...
		private void Constant()
		{
			...
			// Message to 'vbool46' from IsGreaterThan factor
			vbool46_F = IsGreaterThanOp.IsGreaterThanAverageConditional(1, successCount_F);
			...
			// Message to 'vbool47' from Not factor
			vbool47_F = BooleanNotOp.NotAverageConditional(vbool46_F);
