...
namespace Models
{
	...
	public partial class Model25_EP : IGeneratedAlgorithm
	{
		...
		private void Constant()
		{
			...
			// Message to 'vbool52' from IsGreaterThan factor
			vbool52_F = IsGreaterThanOp.IsGreaterThanAverageConditional(2, successCount_F);
			...
			vbool53_F = BooleanNotOp.NotAverageConditional(vbool52_F);
