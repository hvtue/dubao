...
namespace Models
{
	...
	public partial class Model30_EP : IGeneratedAlgorithm
	{
		...
		private void Constant()
		{
			...
			// Message to 'vbool62' from IsGreaterThan factor
			vbool62_F = IsGreaterThanOp.IsGreaterThanAverageConditional(3, successCount_F);
			...
			vbool63_F = BooleanNotOp.NotAverageConditional(vbool62_F);
