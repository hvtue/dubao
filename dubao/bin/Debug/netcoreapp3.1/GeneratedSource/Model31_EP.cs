...
namespace Models
{
	...
	public partial class Model31_EP : IGeneratedAlgorithm
	{
		...
		private void Constant()
		{
			...
			// Message to 'vbool64' from IsGreaterThan factor
			vbool64_F = IsGreaterThanOp.IsGreaterThanAverageConditional(2, successCount_F);
			...
			// Message to 'vbool65' from Not factor
			vbool65_F = BooleanNotOp.NotAverageConditional(vbool64_F);
