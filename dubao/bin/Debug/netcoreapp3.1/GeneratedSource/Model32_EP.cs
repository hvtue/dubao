...
namespace Models
{
	...
	public partial class Model32_EP : IGeneratedAlgorithm
	{
		...
		private void Constant()
		{
			...
			// Message to 'vbool66' from IsGreaterThan factor
			vbool66_F = IsGreaterThanOp.IsGreaterThanAverageConditional(3, successCount_F);
			...
			// Message to 'vbool67' from Not factor
			vbool67_F = BooleanNotOp.NotAverageConditional(vbool66_F);
