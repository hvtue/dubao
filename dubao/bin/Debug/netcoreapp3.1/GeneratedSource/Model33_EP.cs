...
namespace Models
{
	...
	public partial class Model33_EP : IGeneratedAlgorithm
	{
		...
		private void Constant()
		{
			...
			// Message to 'vbool68' from IsGreaterThan factor
			vbool68_F = IsGreaterThanOp.IsGreaterThanAverageConditional(3, successCount_F);
			...
			// Message to 'vbool69' from Not factor
			vbool69_F = BooleanNotOp.NotAverageConditional(vbool68_F);
