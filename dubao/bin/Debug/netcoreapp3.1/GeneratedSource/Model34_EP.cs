...
namespace Models
{
	...
	public partial class Model34_EP : IGeneratedAlgorithm
	{
		...
		private void Constant()
		{
			...
			Bernoulli vbool70_F = default(Bernoulli);
			this.vbool70_marginal_F = Bernoulli.Uniform();
			Bernoulli vbool70_use_B = Bernoulli.Uniform();
			// Message to 'vbool70' from IsGreaterThan factor
			vbool70_F = IsGreaterThanOp.IsGreaterThanAverageConditional(4, successCount_F);
			// Message to 'vbool70_marginal' from DerivedVariable factor
			this.vbool70_marginal_F = DerivedVariableOp.MarginalAverageConditional<Bernoulli>(vbool70_use_B, vbool70_F, this.vbool70_marginal_F);
			Bernoulli vbool71_F = default(Bernoulli);
			this.vbool71_marginal_F = Bernoulli.Uniform();
			Bernoulli vbool71_use_B = Bernoulli.Uniform();
			// Message to 'vbool71' from Not factor
			vbool71_F = BooleanNotOp.NotAverageConditional(vbool70_F);
