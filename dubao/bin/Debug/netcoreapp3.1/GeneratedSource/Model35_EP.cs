...
namespace Models
{
	...
	public partial class Model35_EP : IGeneratedAlgorithm
	{
		...
		private void Constant()
		{
			...
			Bernoulli vbool72_F = default(Bernoulli);
			this.vbool72_marginal_F = Bernoulli.Uniform();
			Bernoulli vbool72_use_B = Bernoulli.Uniform();
			// Message to 'vbool72' from IsGreaterThan factor
			vbool72_F = IsGreaterThanOp.IsGreaterThanAverageConditional(1, successCount_F);
			// Message to 'vbool72_marginal' from DerivedVariable factor
			this.vbool72_marginal_F = DerivedVariableOp.MarginalAverageConditional<Bernoulli>(vbool72_use_B, vbool72_F, this.vbool72_marginal_F);
			Bernoulli vbool73_F = default(Bernoulli);
			this.vbool73_marginal_F = Bernoulli.Uniform();
			Bernoulli vbool73_use_B = Bernoulli.Uniform();
			// Message to 'vbool73' from Not factor
			vbool73_F = BooleanNotOp.NotAverageConditional(vbool72_F);
