...
namespace Models
{
	...
	public partial class Model36_EP : IGeneratedAlgorithm
	{
		...
		private void Constant()
		{
			...
			Bernoulli vbool74_F = default(Bernoulli);
			this.vbool74_marginal_F = Bernoulli.Uniform();
			Bernoulli vbool74_use_B = Bernoulli.Uniform();
			// Message to 'vbool74' from IsGreaterThan factor
			vbool74_F = IsGreaterThanOp.IsGreaterThanAverageConditional(1, successCount_F);
			// Message to 'vbool74_marginal' from DerivedVariable factor
			this.vbool74_marginal_F = DerivedVariableOp.MarginalAverageConditional<Bernoulli>(vbool74_use_B, vbool74_F, this.vbool74_marginal_F);
			Bernoulli vbool75_F = default(Bernoulli);
			this.vbool75_marginal_F = Bernoulli.Uniform();
			Bernoulli vbool75_use_B = Bernoulli.Uniform();
			// Message to 'vbool75' from Not factor
			vbool75_F = BooleanNotOp.NotAverageConditional(vbool74_F);
