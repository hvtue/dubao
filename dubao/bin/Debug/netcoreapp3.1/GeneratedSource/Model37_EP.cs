...
namespace Models
{
	...
	public partial class Model37_EP : IGeneratedAlgorithm
	{
		...
		private void Constant()
		{
			...
			Bernoulli vbool76_F = default(Bernoulli);
			this.vbool76_marginal_F = Bernoulli.Uniform();
			Bernoulli vbool76_use_B = Bernoulli.Uniform();
			// Message to 'vbool76' from IsGreaterThan factor
			vbool76_F = IsGreaterThanOp.IsGreaterThanAverageConditional(1, successCount_F);
			// Message to 'vbool76_marginal' from DerivedVariable factor
			this.vbool76_marginal_F = DerivedVariableOp.MarginalAverageConditional<Bernoulli>(vbool76_use_B, vbool76_F, this.vbool76_marginal_F);
			...
			vbool77_F = BooleanNotOp.NotAverageConditional(vbool76_F);
