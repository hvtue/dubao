...
namespace Models
{
	...
	public partial class Model38_EP : IGeneratedAlgorithm
	{
		...
		private void Constant()
		{
			...
			Bernoulli vbool78_F = default(Bernoulli);
			this.vbool78_marginal_F = Bernoulli.Uniform();
			Bernoulli vbool78_use_B = Bernoulli.Uniform();
			// Message to 'vbool78' from IsGreaterThan factor
			vbool78_F = IsGreaterThanOp.IsGreaterThanAverageConditional(4, successCount_F);
			// Message to 'vbool78_marginal' from DerivedVariable factor
			this.vbool78_marginal_F = DerivedVariableOp.MarginalAverageConditional<Bernoulli>(vbool78_use_B, vbool78_F, this.vbool78_marginal_F);
			Bernoulli vbool79_F = default(Bernoulli);
			this.vbool79_marginal_F = Bernoulli.Uniform();
			Bernoulli vbool79_use_B = Bernoulli.Uniform();
			// Message to 'vbool79' from Not factor
			vbool79_F = BooleanNotOp.NotAverageConditional(vbool78_F);
			// Message to 'vbool79_marginal' from DerivedVariable factor
			this.vbool79_marginal_F = DerivedVariableOp.MarginalAverageConditional<Bernoulli>(vbool79_use_B, vbool79_F, this.vbool79_marginal_F);
