...
namespace Models
{
	...
	public partial class Model39_EP : IGeneratedAlgorithm
	{
		...
		private void Constant()
		{
			...
			Bernoulli vbool80_F = default(Bernoulli);
			this.vbool80_marginal_F = Bernoulli.Uniform();
			Bernoulli vbool80_use_B = Bernoulli.Uniform();
			// Message to 'vbool80' from IsGreaterThan factor
			vbool80_F = IsGreaterThanOp.IsGreaterThanAverageConditional(2, successCount_F);
			// Message to 'vbool80_marginal' from DerivedVariable factor
			this.vbool80_marginal_F = DerivedVariableOp.MarginalAverageConditional<Bernoulli>(vbool80_use_B, vbool80_F, this.vbool80_marginal_F);
			Bernoulli vbool81_F = default(Bernoulli);
			this.vbool81_marginal_F = Bernoulli.Uniform();
			Bernoulli vbool81_use_B = Bernoulli.Uniform();
			// Message to 'vbool81' from Not factor
			vbool81_F = BooleanNotOp.NotAverageConditional(vbool80_F);
