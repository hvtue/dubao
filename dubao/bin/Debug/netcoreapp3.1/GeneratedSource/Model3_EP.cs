...
namespace Models
{
	...
	public partial class Model3_EP : IGeneratedAlgorithm
	{
		...
		private void Constant()
		{
			...
			// Message to 'vbool8' from IsGreaterThan factor
			vbool8_F = IsGreaterThanOp.IsGreaterThanAverageConditional(3, successCount_F);
			...
			// Message to 'vbool9' from Not factor
			vbool9_F = BooleanNotOp.NotAverageConditional(vbool8_F);
