...
namespace Models
{
	...
	public partial class Model40_EP : IGeneratedAlgorithm
	{
		...
		private void Constant()
		{
			...
			Bernoulli vbool82_F = default(Bernoulli);
			this.vbool82_marginal_F = Bernoulli.Uniform();
			Bernoulli vbool82_use_B = Bernoulli.Uniform();
			// Message to 'vbool82' from IsGreaterThan factor
			vbool82_F = IsGreaterThanOp.IsGreaterThanAverageConditional(2, successCount_F);
			// Message to 'vbool82_marginal' from DerivedVariable factor
			this.vbool82_marginal_F = DerivedVariableOp.MarginalAverageConditional<Bernoulli>(vbool82_use_B, vbool82_F, this.vbool82_marginal_F);
			Bernoulli vbool83_F = default(Bernoulli);
			this.vbool83_marginal_F = Bernoulli.Uniform();
			Bernoulli vbool83_use_B = Bernoulli.Uniform();
			// Message to 'vbool83' from Not factor
			vbool83_F = BooleanNotOp.NotAverageConditional(vbool82_F);
