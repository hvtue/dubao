...
namespace Models
{
	...
	public partial class Model41_EP : IGeneratedAlgorithm
	{
		...
		private void Constant()
		{
			...
			Bernoulli vbool84_F = default(Bernoulli);
			this.vbool84_marginal_F = Bernoulli.Uniform();
			Bernoulli vbool84_use_B = Bernoulli.Uniform();
			// Message to 'vbool84' from IsGreaterThan factor
			vbool84_F = IsGreaterThanOp.IsGreaterThanAverageConditional(2, successCount_F);
			// Message to 'vbool84_marginal' from DerivedVariable factor
			this.vbool84_marginal_F = DerivedVariableOp.MarginalAverageConditional<Bernoulli>(vbool84_use_B, vbool84_F, this.vbool84_marginal_F);
			Bernoulli vbool85_F = default(Bernoulli);
			this.vbool85_marginal_F = Bernoulli.Uniform();
			Bernoulli vbool85_use_B = Bernoulli.Uniform();
			// Message to 'vbool85' from Not factor
			vbool85_F = BooleanNotOp.NotAverageConditional(vbool84_F);
