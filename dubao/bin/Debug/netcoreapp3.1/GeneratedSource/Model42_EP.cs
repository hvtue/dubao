...
namespace Models
{
	...
	public partial class Model42_EP : IGeneratedAlgorithm
	{
		...
		private void Constant()
		{
			...
			Bernoulli vbool86_F = default(Bernoulli);
			this.vbool86_marginal_F = Bernoulli.Uniform();
			Bernoulli vbool86_use_B = Bernoulli.Uniform();
			// Message to 'vbool86' from IsGreaterThan factor
			vbool86_F = IsGreaterThanOp.IsGreaterThanAverageConditional(4, successCount_F);
			// Message to 'vbool86_marginal' from DerivedVariable factor
			this.vbool86_marginal_F = DerivedVariableOp.MarginalAverageConditional<Bernoulli>(vbool86_use_B, vbool86_F, this.vbool86_marginal_F);
			Bernoulli vbool87_F = default(Bernoulli);
			this.vbool87_marginal_F = Bernoulli.Uniform();
			Bernoulli vbool87_use_B = Bernoulli.Uniform();
			// Message to 'vbool87' from Not factor
			vbool87_F = BooleanNotOp.NotAverageConditional(vbool86_F);
