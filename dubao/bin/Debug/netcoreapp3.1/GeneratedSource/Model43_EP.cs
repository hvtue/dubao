...
namespace Models
{
	...
	public partial class Model43_EP : IGeneratedAlgorithm
	{
		...
		private void Constant()
		{
			...
			Bernoulli vbool88_F = default(Bernoulli);
			this.vbool88_marginal_F = Bernoulli.Uniform();
			Bernoulli vbool88_use_B = Bernoulli.Uniform();
			// Message to 'vbool88' from IsGreaterThan factor
			vbool88_F = IsGreaterThanOp.IsGreaterThanAverageConditional(1, successCount_F);
			// Message to 'vbool88_marginal' from DerivedVariable factor
			this.vbool88_marginal_F = DerivedVariableOp.MarginalAverageConditional<Bernoulli>(vbool88_use_B, vbool88_F, this.vbool88_marginal_F);
			...
			vbool89_F = BooleanNotOp.NotAverageConditional(vbool88_F);
