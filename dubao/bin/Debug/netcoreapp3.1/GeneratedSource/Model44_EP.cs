...
namespace Models
{
	...
	public partial class Model44_EP : IGeneratedAlgorithm
	{
		...
		private void Constant()
		{
			...
			Bernoulli vbool90_F = default(Bernoulli);
			this.vbool90_marginal_F = Bernoulli.Uniform();
			Bernoulli vbool90_use_B = Bernoulli.Uniform();
			// Message to 'vbool90' from IsGreaterThan factor
			vbool90_F = IsGreaterThanOp.IsGreaterThanAverageConditional(1, successCount_F);
			// Message to 'vbool90_marginal' from DerivedVariable factor
			this.vbool90_marginal_F = DerivedVariableOp.MarginalAverageConditional<Bernoulli>(vbool90_use_B, vbool90_F, this.vbool90_marginal_F);
			Bernoulli vbool91_F = default(Bernoulli);
			this.vbool91_marginal_F = Bernoulli.Uniform();
			Bernoulli vbool91_use_B = Bernoulli.Uniform();
			// Message to 'vbool91' from Not factor
			vbool91_F = BooleanNotOp.NotAverageConditional(vbool90_F);
