...
namespace Models
{
	...
	public partial class Model45_EP : IGeneratedAlgorithm
	{
		...
		private void Constant()
		{
			...
			Bernoulli vbool92_F = default(Bernoulli);
			this.vbool92_marginal_F = Bernoulli.Uniform();
			Bernoulli vbool92_use_B = Bernoulli.Uniform();
			// Message to 'vbool92' from IsGreaterThan factor
			vbool92_F = IsGreaterThanOp.IsGreaterThanAverageConditional(2, successCount_F);
			// Message to 'vbool92_marginal' from DerivedVariable factor
			this.vbool92_marginal_F = DerivedVariableOp.MarginalAverageConditional<Bernoulli>(vbool92_use_B, vbool92_F, this.vbool92_marginal_F);
			Bernoulli vbool93_F = default(Bernoulli);
			this.vbool93_marginal_F = Bernoulli.Uniform();
			Bernoulli vbool93_use_B = Bernoulli.Uniform();
			// Message to 'vbool93' from Not factor
			vbool93_F = BooleanNotOp.NotAverageConditional(vbool92_F);
