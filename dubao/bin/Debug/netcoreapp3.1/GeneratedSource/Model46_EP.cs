...
namespace Models
{
	...
	public partial class Model46_EP : IGeneratedAlgorithm
	{
		...
		private void Constant()
		{
			...
			Bernoulli vbool94_F = default(Bernoulli);
			this.vbool94_marginal_F = Bernoulli.Uniform();
			Bernoulli vbool94_use_B = Bernoulli.Uniform();
			// Message to 'vbool94' from IsGreaterThan factor
			vbool94_F = IsGreaterThanOp.IsGreaterThanAverageConditional(3, successCount_F);
			// Message to 'vbool94_marginal' from DerivedVariable factor
			this.vbool94_marginal_F = DerivedVariableOp.MarginalAverageConditional<Bernoulli>(vbool94_use_B, vbool94_F, this.vbool94_marginal_F);
			Bernoulli vbool95_F = default(Bernoulli);
			this.vbool95_marginal_F = Bernoulli.Uniform();
			Bernoulli vbool95_use_B = Bernoulli.Uniform();
			// Message to 'vbool95' from Not factor
			vbool95_F = BooleanNotOp.NotAverageConditional(vbool94_F);
