...
namespace Models
{
	...
	public partial class Model47_EP : IGeneratedAlgorithm
	{
		...
		private void Constant()
		{
			...
			Bernoulli vbool96_F = default(Bernoulli);
			this.vbool96_marginal_F = Bernoulli.Uniform();
			Bernoulli vbool96_use_B = Bernoulli.Uniform();
			// Message to 'vbool96' from IsGreaterThan factor
			vbool96_F = IsGreaterThanOp.IsGreaterThanAverageConditional(1, successCount_F);
			// Message to 'vbool96_marginal' from DerivedVariable factor
			this.vbool96_marginal_F = DerivedVariableOp.MarginalAverageConditional<Bernoulli>(vbool96_use_B, vbool96_F, this.vbool96_marginal_F);
			Bernoulli vbool97_F = default(Bernoulli);
			this.vbool97_marginal_F = Bernoulli.Uniform();
			Bernoulli vbool97_use_B = Bernoulli.Uniform();
			// Message to 'vbool97' from Not factor
			vbool97_F = BooleanNotOp.NotAverageConditional(vbool96_F);
			// Message to 'vbool97_marginal' from DerivedVariable factor
			this.vbool97_marginal_F = DerivedVariableOp.MarginalAverageConditional<Bernoulli>(vbool97_use_B, vbool97_F, this.vbool97_marginal_F);
