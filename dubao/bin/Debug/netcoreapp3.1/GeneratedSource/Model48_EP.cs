...
namespace Models
{
	...
	public partial class Model48_EP : IGeneratedAlgorithm
	{
		...
		private void Constant()
		{
			...
			Bernoulli vbool98_F = default(Bernoulli);
			this.vbool98_marginal_F = Bernoulli.Uniform();
			Bernoulli vbool98_use_B = Bernoulli.Uniform();
			// Message to 'vbool98' from IsGreaterThan factor
			vbool98_F = IsGreaterThanOp.IsGreaterThanAverageConditional(2, successCount_F);
			// Message to 'vbool98_marginal' from DerivedVariable factor
			this.vbool98_marginal_F = DerivedVariableOp.MarginalAverageConditional<Bernoulli>(vbool98_use_B, vbool98_F, this.vbool98_marginal_F);
			Bernoulli vbool99_F = default(Bernoulli);
			this.vbool99_marginal_F = Bernoulli.Uniform();
			Bernoulli vbool99_use_B = Bernoulli.Uniform();
			// Message to 'vbool99' from Not factor
			vbool99_F = BooleanNotOp.NotAverageConditional(vbool98_F);
