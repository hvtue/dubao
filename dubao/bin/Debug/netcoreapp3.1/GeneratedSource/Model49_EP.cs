...
namespace Models
{
	...
	public partial class Model49_EP : IGeneratedAlgorithm
	{
		...
		private void Constant()
		{
			...
			Bernoulli vbool100_F = default(Bernoulli);
			this.vbool100_marginal_F = Bernoulli.Uniform();
			Bernoulli vbool100_use_B = Bernoulli.Uniform();
			// Message to 'vbool100' from IsGreaterThan factor
			vbool100_F = IsGreaterThanOp.IsGreaterThanAverageConditional(2, successCount_F);
			// Message to 'vbool100_marginal' from DerivedVariable factor
			this.vbool100_marginal_F = DerivedVariableOp.MarginalAverageConditional<Bernoulli>(vbool100_use_B, vbool100_F, this.vbool100_marginal_F);
			...
			vbool101_F = BooleanNotOp.NotAverageConditional(vbool100_F);
