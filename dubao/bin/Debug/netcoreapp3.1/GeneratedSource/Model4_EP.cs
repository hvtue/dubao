...
namespace Models
{
	...
	public partial class Model4_EP : IGeneratedAlgorithm
	{
		...
		private void Constant()
		{
			...
			// Message to 'vbool10' from IsGreaterThan factor
			vbool10_F = IsGreaterThanOp.IsGreaterThanAverageConditional(3, successCount_F);
			...
			// Message to 'vbool11' from Not factor
			vbool11_F = BooleanNotOp.NotAverageConditional(vbool10_F);
