...
namespace Models
{
	...
	public partial class Model50_EP : IGeneratedAlgorithm
	{
		...
		private void Constant()
		{
			...
			Bernoulli vbool102_F = default(Bernoulli);
			this.vbool102_marginal_F = Bernoulli.Uniform();
			Bernoulli vbool102_use_B = Bernoulli.Uniform();
			// Message to 'vbool102' from IsGreaterThan factor
			vbool102_F = IsGreaterThanOp.IsGreaterThanAverageConditional(1, successCount_F);
			// Message to 'vbool102_marginal' from DerivedVariable factor
			this.vbool102_marginal_F = DerivedVariableOp.MarginalAverageConditional<Bernoulli>(vbool102_use_B, vbool102_F, this.vbool102_marginal_F);
			...
			// Message to 'vbool103' from Not factor
			vbool103_F = BooleanNotOp.NotAverageConditional(vbool102_F);
