...
namespace Models
{
	...
	public partial class Model51_EP : IGeneratedAlgorithm
	{
		...
		private void Constant()
		{
			...
			Bernoulli vbool104_F = default(Bernoulli);
			this.vbool104_marginal_F = Bernoulli.Uniform();
			Bernoulli vbool104_use_B = Bernoulli.Uniform();
			// Message to 'vbool104' from IsGreaterThan factor
			vbool104_F = IsGreaterThanOp.IsGreaterThanAverageConditional(2, successCount_F);
			// Message to 'vbool104_marginal' from DerivedVariable factor
			this.vbool104_marginal_F = DerivedVariableOp.MarginalAverageConditional<Bernoulli>(vbool104_use_B, vbool104_F, this.vbool104_marginal_F);
			...
			// Message to 'vbool105' from Not factor
			vbool105_F = BooleanNotOp.NotAverageConditional(vbool104_F);
