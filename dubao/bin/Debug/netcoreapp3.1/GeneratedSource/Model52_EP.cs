...
namespace Models
{
	...
	public partial class Model52_EP : IGeneratedAlgorithm
	{
		...
		private void Constant()
		{
			...
			Bernoulli vbool106_F = default(Bernoulli);
			this.vbool106_marginal_F = Bernoulli.Uniform();
			Bernoulli vbool106_use_B = Bernoulli.Uniform();
			// Message to 'vbool106' from IsGreaterThan factor
			vbool106_F = IsGreaterThanOp.IsGreaterThanAverageConditional(1, successCount_F);
			// Message to 'vbool106_marginal' from DerivedVariable factor
			this.vbool106_marginal_F = DerivedVariableOp.MarginalAverageConditional<Bernoulli>(vbool106_use_B, vbool106_F, this.vbool106_marginal_F);
			...
			// Message to 'vbool107' from Not factor
			vbool107_F = BooleanNotOp.NotAverageConditional(vbool106_F);
