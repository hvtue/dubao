...
namespace Models
{
	...
	public partial class Model53_EP : IGeneratedAlgorithm
	{
		...
		private void Constant()
		{
			...
			Bernoulli vbool108_F = default(Bernoulli);
			this.vbool108_marginal_F = Bernoulli.Uniform();
			Bernoulli vbool108_use_B = Bernoulli.Uniform();
			// Message to 'vbool108' from IsGreaterThan factor
			vbool108_F = IsGreaterThanOp.IsGreaterThanAverageConditional(1, successCount_F);
			// Message to 'vbool108_marginal' from DerivedVariable factor
			this.vbool108_marginal_F = DerivedVariableOp.MarginalAverageConditional<Bernoulli>(vbool108_use_B, vbool108_F, this.vbool108_marginal_F);
			...
			// Message to 'vbool109' from Not factor
			vbool109_F = BooleanNotOp.NotAverageConditional(vbool108_F);
