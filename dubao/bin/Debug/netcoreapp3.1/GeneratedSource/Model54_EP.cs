...
namespace Models
{
	...
	public partial class Model54_EP : IGeneratedAlgorithm
	{
		...
		private void Constant()
		{
			...
			Bernoulli vbool110_F = default(Bernoulli);
			this.vbool110_marginal_F = Bernoulli.Uniform();
			Bernoulli vbool110_use_B = Bernoulli.Uniform();
			// Message to 'vbool110' from IsGreaterThan factor
			vbool110_F = IsGreaterThanOp.IsGreaterThanAverageConditional(1, successCount_F);
			// Message to 'vbool110_marginal' from DerivedVariable factor
			this.vbool110_marginal_F = DerivedVariableOp.MarginalAverageConditional<Bernoulli>(vbool110_use_B, vbool110_F, this.vbool110_marginal_F);
			...
			vbool111_F = BooleanNotOp.NotAverageConditional(vbool110_F);
