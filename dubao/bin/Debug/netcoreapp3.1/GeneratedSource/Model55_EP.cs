...
namespace Models
{
	...
	public partial class Model55_EP : IGeneratedAlgorithm
	{
		...
		private void Constant()
		{
			...
			Bernoulli vbool112_F = default(Bernoulli);
			this.vbool112_marginal_F = Bernoulli.Uniform();
			Bernoulli vbool112_use_B = Bernoulli.Uniform();
			// Message to 'vbool112' from IsGreaterThan factor
			vbool112_F = IsGreaterThanOp.IsGreaterThanAverageConditional(2, successCount_F);
			// Message to 'vbool112_marginal' from DerivedVariable factor
			this.vbool112_marginal_F = DerivedVariableOp.MarginalAverageConditional<Bernoulli>(vbool112_use_B, vbool112_F, this.vbool112_marginal_F);
			...
			vbool113_F = BooleanNotOp.NotAverageConditional(vbool112_F);
