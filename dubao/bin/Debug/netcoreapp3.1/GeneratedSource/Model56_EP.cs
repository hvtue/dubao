...
namespace Models
{
	...
	public partial class Model56_EP : IGeneratedAlgorithm
	{
		...
		private void Constant()
		{
			...
			Bernoulli vbool114_F = default(Bernoulli);
			this.vbool114_marginal_F = Bernoulli.Uniform();
			Bernoulli vbool114_use_B = Bernoulli.Uniform();
			// Message to 'vbool114' from IsGreaterThan factor
			vbool114_F = IsGreaterThanOp.IsGreaterThanAverageConditional(3, successCount_F);
			// Message to 'vbool114_marginal' from DerivedVariable factor
			this.vbool114_marginal_F = DerivedVariableOp.MarginalAverageConditional<Bernoulli>(vbool114_use_B, vbool114_F, this.vbool114_marginal_F);
			...
			// Message to 'vbool115' from Not factor
			vbool115_F = BooleanNotOp.NotAverageConditional(vbool114_F);
