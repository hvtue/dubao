...
namespace Models
{
	...
	public partial class Model5_EP : IGeneratedAlgorithm
	{
		...
		private void Constant()
		{
			...
			// Message to 'vbool12' from IsGreaterThan factor
			vbool12_F = IsGreaterThanOp.IsGreaterThanAverageConditional(2, successCount_F);
			...
			vbool13_F = BooleanNotOp.NotAverageConditional(vbool12_F);
