...
namespace Models
{
	...
	public partial class Model6_EP : IGeneratedAlgorithm
	{
		...
		private void Constant()
		{
			...
			// Message to 'vbool14' from IsGreaterThan factor
			vbool14_F = IsGreaterThanOp.IsGreaterThanAverageConditional(2, successCount_F);
			...
			// Message to 'vbool15' from Not factor
			vbool15_F = BooleanNotOp.NotAverageConditional(vbool14_F);
