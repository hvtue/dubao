...
namespace Models
{
	...
	public partial class Model73_EP : IGeneratedAlgorithm
	{
		...
		public Bernoulli vbool148_marginal_F;
		/// <summary>Message to marginal of 'vbool149'</summary>
		public Bernoulli vbool149_marginal_F;
		#endregion
		...
		private void Constant()
		{
			...
			Bernoulli vbool148_F = default(Bernoulli);
			this.vbool148_marginal_F = Bernoulli.Uniform();
			Bernoulli vbool148_use_B = Bernoulli.Uniform();
			// Message to 'vbool148' from IsGreaterThan factor
			vbool148_F = IsGreaterThanOp.IsGreaterThanAverageConditional(1, successCount_F);
			// Message to 'vbool148_marginal' from DerivedVariable factor
			this.vbool148_marginal_F = DerivedVariableOp.MarginalAverageConditional<Bernoulli>(vbool148_use_B, vbool148_F, this.vbool148_marginal_F);
			Bernoulli vbool149_F = default(Bernoulli);
			this.vbool149_marginal_F = Bernoulli.Uniform();
			Bernoulli vbool149_use_B = Bernoulli.Uniform();
			// Message to 'vbool149' from Not factor
			vbool149_F = BooleanNotOp.NotAverageConditional(vbool148_F);
			// Message to 'vbool149_marginal' from DerivedVariable factor
			this.vbool149_marginal_F = DerivedVariableOp.MarginalAverageConditional<Bernoulli>(vbool149_use_B, vbool149_F, this.vbool149_marginal_F);
		...
		{
			return this.vbool148_marginal_F;
		}
		...
		{
			return this.vbool149_marginal_F;
		}
