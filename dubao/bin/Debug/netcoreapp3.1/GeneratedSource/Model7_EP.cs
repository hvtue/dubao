...
namespace Models
{
	...
	public partial class Model7_EP : IGeneratedAlgorithm
	{
		...
		private void Constant()
		{
			...
			// Message to 'vbool16' from IsGreaterThan factor
			vbool16_F = IsGreaterThanOp.IsGreaterThanAverageConditional(2, successCount_F);
			...
			// Message to 'vbool17' from Not factor
			vbool17_F = BooleanNotOp.NotAverageConditional(vbool16_F);
