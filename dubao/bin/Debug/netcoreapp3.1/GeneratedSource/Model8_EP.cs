...
namespace Models
{
	...
	public partial class Model8_EP : IGeneratedAlgorithm
	{
		...
		private void Constant()
		{
			...
			// Message to 'vbool18' from IsGreaterThan factor
			vbool18_F = IsGreaterThanOp.IsGreaterThanAverageConditional(3, successCount_F);
			...
			// Message to 'vbool19' from Not factor
			vbool19_F = BooleanNotOp.NotAverageConditional(vbool18_F);
