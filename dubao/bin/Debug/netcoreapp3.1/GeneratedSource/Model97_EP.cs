...
namespace Models
{
	...
	/// </remarks>
	public partial class Model97_EP : IGeneratedAlgorithm
	{
		#region Fields
		...
		public Bernoulli vbool196_marginal_F;
		...
		private void Constant()
		{
			...
			Bernoulli vbool196_F = default(Bernoulli);
			this.vbool196_marginal_F = Bernoulli.Uniform();
			Bernoulli vbool196_use_B = Bernoulli.Uniform();
			// Message to 'vbool196' from IsGreaterThan factor
			vbool196_F = IsGreaterThanOp.IsGreaterThanAverageConditional(2, successCount_F);
			// Message to 'vbool196_marginal' from DerivedVariable factor
			this.vbool196_marginal_F = DerivedVariableOp.MarginalAverageConditional<Bernoulli>(vbool196_use_B, vbool196_F, this.vbool196_marginal_F);
			Bernoulli vbool197_F = default(Bernoulli);
			this.vbool197_marginal_F = Bernoulli.Uniform();
			Bernoulli vbool197_use_B = Bernoulli.Uniform();
			// Message to 'vbool197' from Not factor
			vbool197_F = BooleanNotOp.NotAverageConditional(vbool196_F);
			// Message to 'vbool197_marginal' from DerivedVariable factor
			this.vbool197_marginal_F = DerivedVariableOp.MarginalAverageConditional<Bernoulli>(vbool197_use_B, vbool197_F, this.vbool197_marginal_F);
		...
		{
			return this.vbool196_marginal_F;
		}
