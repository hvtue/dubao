...
namespace Models
{
	...
	public partial class Model98_EP : IGeneratedAlgorithm
	{
		...
		public Bernoulli vbool199_marginal_F;
		#endregion
		...
		private void Constant()
		{
			...
			Bernoulli vbool198_F = default(Bernoulli);
			this.vbool198_marginal_F = Bernoulli.Uniform();
			Bernoulli vbool198_use_B = Bernoulli.Uniform();
			// Message to 'vbool198' from IsGreaterThan factor
			vbool198_F = IsGreaterThanOp.IsGreaterThanAverageConditional(2, successCount_F);
			// Message to 'vbool198_marginal' from DerivedVariable factor
			this.vbool198_marginal_F = DerivedVariableOp.MarginalAverageConditional<Bernoulli>(vbool198_use_B, vbool198_F, this.vbool198_marginal_F);
			Bernoulli vbool199_F = default(Bernoulli);
			this.vbool199_marginal_F = Bernoulli.Uniform();
			Bernoulli vbool199_use_B = Bernoulli.Uniform();
			// Message to 'vbool199' from Not factor
			vbool199_F = BooleanNotOp.NotAverageConditional(vbool198_F);
			// Message to 'vbool199_marginal' from DerivedVariable factor
			this.vbool199_marginal_F = DerivedVariableOp.MarginalAverageConditional<Bernoulli>(vbool199_use_B, vbool199_F, this.vbool199_marginal_F);
		...
		{
			return this.vbool199_marginal_F;
		}
