...
namespace Models
{
	...
	public partial class Model9_EP : IGeneratedAlgorithm
	{
		...
		private void Constant()
		{
			...
			// Message to 'vbool20' from IsGreaterThan factor
			vbool20_F = IsGreaterThanOp.IsGreaterThanAverageConditional(1, successCount_F);
			...
			vbool21_F = BooleanNotOp.NotAverageConditional(vbool20_F);
